...
func TestAddAndMv(t *testing.T) {
	...
	expectedMemory := []byte{
		0b00010000, 0b00100010, 0b00011000, 0b00000000, // ADD W1, W2, W3
...
func TestAddTwoNumber(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00010000, 0b00000001, 0b00010000, 0b00000000, // ADD W0, W1, W2
	}
...
func TestBranches(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00101000, 0b00000000, 0b00000000, 0b01000000, // JUMP COMPARE_FUNC
		0b00101000, 0b00000000, 0b00000001, 0b01100000, // JUMP _end
		0b00100100, 0b00000001, 0b00010000, 0b00000000, // CMP W1, W2
		0b00110000, 0b00000000, 0b00000000, 0b01100000, // BEQ SET_EQUAL
		0b00110100, 0b00000000, 0b00000000, 0b10000000, // BLT SET_LESS
		0b00111000, 0b00000000, 0b00000000, 0b10100000, // BGT SET_GREATER
		0b00000000, 0b00000000, 0b00000000, 0b00100000, // MV W0, #0
		0b00101100, 0b00000101, 0b00000000, 0b00000000, // JMPR W5
...
func TestDivideNegatives(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00000000, 0b01000000, 0b00000000, 0b01100000, // MV W2, #3
		0b00100000, 0b00000001, 0b00010000, 0b00000000, // SDIV W0, W1, W2
	}
...
func TestDividePositives(t *testing.T) {
	...
	expectedMemory := []byte{
		0b00000000, 0b00100000, 0b00000001, 0b11100000, // MV W1, #15
		0b00000000, 0b01000000, 0b00000000, 0b01100000, // MV W2, #3
		0b00011100, 0b00000001, 0b00010000, 0b00000000, // UDIV W0, W1, W2
	}
...
func TestMret(t *testing.T) {
	...
	expectedMemory := []byte{
		0b01011000, 0b00000000, 0b00000000, 0b00000000, // MRET
	}
...
func TestMultiplyTwoNumbers(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00010000, 0b00000000, 0b00001000, 0b00000000, // ADD W0, W0, W1 (1st time)
		0b00010000, 0b00000000, 0b00001000, 0b00000000, // ADD W0, W0, W1 (2nd time)
		0b00010000, 0b00000000, 0b00001000, 0b00000000, // ADD W0, W0, W1 (3rd time)
		0b00010000, 0b00000000, 0b00001000, 0b00000000, // ADD W0, W0, W1 (4th time)
		0b00010000, 0b00000000, 0b00001000, 0b00000000, // ADD W0, W0, W1 (5th time)
		0b00010000, 0b00000000, 0b00001000, 0b00000000, // ADD W0, W0, W1 (6th time)
	}
...
func TestMultiplyWithMul(t *testing.T) {
	...
	expectedMemory := []byte{
		0b00000000, 0b00100000, 0b00000000, 0b10000000, // MV W1, #4
		0b00000000, 0b01000000, 0b00000000, 0b11000000, // MV W2, #6
		0b00011000, 0b00000001, 0b00010000, 0b00000000, // MUL W0, W1, W2
	}
...
func TestSimpleJump(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00101000, 0b00000000, 0b00000000, 0b01100000, // JUMP 0x14
...
func TestStoreAndLoadByte(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b01010100, 0b00000011, 0b00001000, 0b00000000, // STRB W3, W1
		0b01001100, 0b00000010, 0b00001000, 0b00000000, // LDB W2, W1
		0b01010000, 0b00000100, 0b00001000, 0b00000000, // LDSB W4, W1
	}
...
func TestStoreAndLoadDWord(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00000000, 0b00100000, 0b00000100, 0b00000000, // MV W1, #0x020
		0b01001000, 0b01100000, 0b00000100, 0b00000000, // STRD W3, #0x020
		0b01000100, 0b01000000, 0b00000100, 0b00000000, // LDD W2, #0x020
	}
...
func TestStoreAndLoad(t *testing.T) {
	...
	expectedMemory := []byte{
		0b00000000, 0b01100000, 0b00001000, 0b01000000, // MV W3, #66
		0b00000000, 0b00100000, 0b00000100, 0b00000000, // MV W1, #0x020
		0b01000000, 0b00000011, 0b00001000, 0b00000000, // STORE W3, W1
		0b00111100, 0b00000010, 0b00001000, 0b00000000, // LOAD W2, W1
	}
...
func TestSubAndCmp(t *testing.T) {
	...
	expectedMemory := []byte{
		...
		0b00010100, 0b01100011, 0b00101000, 0b00000000, // SUB W3, W3, W5
		0b00100100, 0b00000101, 0b00011000, 0b00000000, // CMP W5, W3
	}
...
func TestSyscall(t *testing.T) {
	...
	expectedMemory := []byte{
		0b01011100, 0b00000000, 0b00000000, 0b01000000, // SYSCALL #2
	}
